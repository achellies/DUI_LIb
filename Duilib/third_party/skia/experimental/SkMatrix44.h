...
public:
    ...
    void setScale(SkMScalar dx, SkMScalar dy, SkMScalar dz);
    void preScale(SkMScalar dx, SkMScalar dy, SkMScalar dz);
    void postScale(SkMScalar dx, SkMScalar dy, SkMScalar dz);
