 ...
 *		BOOL			whether the increment was successful
 */
BOOL CRTFLog::AddAt(LPCSTR lpcstrKeyword)
{
	INDEX i;
 ...
 *		BOOL			whether the increment was successful
 */
BOOL CRTFLog::AddAt(TOKEN token)
{
	INDEX i;
 ...
 */
BOOL CRTFLog::GetAt(LPCSTR lpcstrKeyword, PELEMENT pelemCount) const
{
	INDEX i;
 ...
 *		BOOL		indicates whether a hit count was found for the element
 */
BOOL CRTFLog::GetAt(TOKEN token, PELEMENT pelemCount) const
{
	INDEX i;
