...
CharLowerWrap(LPWSTR pwstr)
{
    ...
    return CharChangeCaseWrap(pwstr, (FnCharChangeCase)CharLowerA);
}
#endif
...
CharLowerBuffWrap(LPWSTR pwstr, DWORD cchLength)
{
	...
	for (pos = 0; pos < cchLength; pos++, lpBuffer++)
		*lpBuffer =  (WCHAR)CharChangeCaseWrap((LPWSTR)*lpBuffer, (FnCharChangeCase)CharLowerA);
	return pos;
}
#endif
...
CharUpperBuffWrap(LPWSTR pwstr, DWORD cchLength)
{
	...
	LPWSTR lpBuffer = pwstr;
	for (pos = 0; pos < cchLength; pos++, lpBuffer++)
		*lpBuffer =  (WCHAR)CharChangeCaseWrap((LPWSTR)*lpBuffer, (FnCharChangeCase)CharUpperA);
	return pos;
}
#endif // PRODUCT_95
        ...
        CONST DEVMODEW *    lpInitData)
{
    ...
    return CreateHDCWrap(lpszDriver, lpszDevice, lpszOutput, lpInitData, (FnCreateHDCA)CreateICA);
}
#endif
