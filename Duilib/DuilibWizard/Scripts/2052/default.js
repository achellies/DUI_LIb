...
function AddFilters(proj)
{
	try
	{
		...
		var group2 = proj.Object.AddFilter('头文件');
		group2.Filter = strIncFilter;

		var strPicFilter = wizard.FindSymbol('PICTRUE_FILTER');
		var group3 = proj.Object.AddFilter('图像文件');
		group3.Filter = strPicFilter;
	}
	catch(e)
	{
		throw e;
...
function AddConfig(proj, strProjectName)
{
	try
	{
        ...
        CLTool.WarnAsError = false;
        CLTool.UseUnicodeResponseFiles = true;
        ...
        CLTool.PrecompiledHeaderFile = ".\\$(ConfigurationName)/" + strProjectName + ".pch";

		var LinkTool = config.Tools('VCLinkerTool');

		LinkTool.LinkIncremental = linkIncrementalYes;
		LinkTool.SuppressStartupBanner = true;
		LinkTool.GenerateManifest = true;
		LinkTool.AllowIsolation = true;
		LinkTool.GenerateDebugInformation = true;
		LinkTool.GenerateMapFile = true;
		LinkTool.MapFileName = ".\\$(ConfigurationName)/" + strProjectName + ".map";
		...
		CLTool.FavorSizeOrSpeed = favorNone;
...
function GetTargetName(strName, strProjectName)
{
	try
	{
        ...
        if (strName == 'test1.xml')
            strTarget = 'test1.xml';

        if (strName == 'scrollbar.bmp')
            strTarget = 'scrollbar.bmp';
...
// SIG // MDgwODAxMDUwMjA2WjAjBgkqhkiG9w0BCQQxFgQUgNY9
// SIG // BMpz/JH52ULyh7bXEpMrCPgwDQYJKoZIhvcNAQEFBQAE
// SIG // ggEAh3izpzwCOZ8QO/I6CKeQ/2ZPs+ZlfwelqmaJZUg1
// SIG // /YkM03jAyKXNRJ0ff0s2/WDCOF9s0UM7AdXRLe7sU4Ho
// SIG // bIzehz6xHPVe4KHibNtpX+n5yBMmBsSgxsjP2plwzlpF
// SIG // or6um6nn7W0nQZmoybSX6G1OTddZlJ6XgIPVu0Z+Zga7
// SIG // 5x9JpDIa61XRyztOSdkiBJGF8D2hSuestVd7gZuPIj9F
// SIG // rG2tfiZkXYjRsEd+y+qy2M2ljsTbY1Vn0rhvJYFyQSTS
// SIG // FP8ec16NIlOrwdt+QAlD0s7oPGBxdHioeffzjo6Ba9+B
// SIG // qIYXTQTbeaOapGIOJcDQRANm+oa1HNegtEr3kA==
