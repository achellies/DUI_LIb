...
class CDialogUI:public CWindowWnd, public INotifyUI, public IDialogBuilderCallback
{
public:
	CDialogUI(){};
	~CDialogUI(){};
	...
	{
		if( _tcscmp(pstrClass, _T("ComputerExamine")) == 0 ) return new ComputerExamineUI(pManager);
		return NULL;
	}
