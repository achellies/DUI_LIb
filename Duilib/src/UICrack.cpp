...
UILIB_API const TCHAR* const kListUIInterfaceName = _T("CList");

// IListUI
UILIB_API const TCHAR* const kIListUIInterfaceName = _T("List");

// IListOwnerUI
UILIB_API const TCHAR* const kIListOwnerUIInterfaceName = _T("ListOwner");
