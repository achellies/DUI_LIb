...
public:
    ...
    LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
		...
		tString tstrSkin = CPaintManagerUI::GetInstancePath() + _T("Skins\\ListDemo\\");
...
class ListMainForm : public CWindowWnd, public INotifyUI, public IListCallbackUI, public IDialogBuilderCallback
{
public:
    ListMainForm() {
    };
